...
function Illustration({ type }: { type: NonNullable<EmptyStateProps["illustration"]> }) {
  ...
  if (type === "auction") return (
    <svg width="48" height="48" viewBox="0 0 48 48" {...style} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10 38h28" /><path d="M18 38V22" /><path d="M30 38V22" />
      <rect x="14" y="18" width="20" height="4" rx="1" />
      <path d="M24 18v-4" /><circle cx="24" cy="11" r="3" />
    </svg>
  );
  ...
  if (type === "wallet") return (
    <svg width="48" height="48" viewBox="0 0 48 48" {...style} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 22h32" /><circle cx="34" cy="28" r="2" />
  ...
  if (type === "search") return (
    <svg width="48" height="48" viewBox="0 0 48 48" {...style} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M30 30l8 8" /><path d="M18 22h8" />
    </svg>
  );
  ...
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" {...style} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M16 16h16" /><path d="M16 22h12" /><path d="M16 28h8" />
    </svg>
  );
}
  ...
  return (
    <div className="card py-14 px-6 flex flex-col items-center text-center">
      <div
        ...
        style={{ width: 72, height: 72, background: "var(--surface-sunken)" }}
      >
        <Illustration type={illustration} />
      </div>
      <p className="text-[15px] font-semibold mb-2" style={{ color: "var(--ink)" }}>
        {title}
      </p>
      <p className="text-[13px] max-w-[320px] leading-relaxed" style={{ color: "var(--ink-muted)" }}>
        {description}
      </p>
      {action && (
